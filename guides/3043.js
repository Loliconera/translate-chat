...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	return {
		...
		"s-3043-1000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_ES: "Ataque Frontal (Stun)" }],
		...
		"s-3043-1000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_ES: "Ataque | Stun Frontal" }],
		"s-3043-1000-126-0": [
		...
		"s-3043-1000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_ES: "Salto Mortal | Ataque hacia atrás" }],
		"s-3043-1000-130-0": [
		...
		"s-3043-1000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_ES: "Frontal Combo" }],
		...
		"s-3043-2000-110-0": [{ type: "text", sub_type: "message", message: "Throw Front (Stun)", message_ES: "Ataque Frontal (Stun)" }],
		...
		"s-3043-2000-125-0": [{ type: "text", sub_type: "message", message: "Hit | Frontal Stun", message_ES: "Ataque | Stun Frontal" }],
		"s-3043-2000-126-0": [
			{ type: "text", sub_type: "message", message: "Frontal Stun", message_ES: "Stun Frontal" },
			{ type: "spawn", func: "vector", args: [553, 60, 220, 20, 500, 0, 2000] },
			{ type: "spawn", func: "vector", args: [553, 300, 220, 340, 500, 0, 2000] }
		],
		"s-3043-2000-129-0": [{ type: "text", sub_type: "message", message: "Somersault | Back Hit", message_ES: "Salto Mortal | Ataque hacia atrás" }],
		"s-3043-2000-130-0": [
			{ type: "text", sub_type: "message", message: "Back Hit (Bleed)", message_ES: "Ataque hacia atrás (Sangrar)" },
			{ type: "spawn", func: "circle", args: [true, 553, 180, 340, null, 250, 0, 2000] }
		],
		"s-3043-2000-142-0": [{ type: "text", sub_type: "message", message: "Frontal Combo", message_ES: "Frontal Combo" }],
		"s-3043-2000-143-0": [{ type: "text", sub_type: "message", message: "Hit | Back Push", message_ES: "Ataque | Empujar hacia atrás" }],
		"s-3043-2000-143-1": [{ type: "text", sub_type: "message", message: "Back Push", message_ES: "Empujar hacia atrás" }],
		"s-3043-2000-144-0": [
		...
		"qb-3043-2000-3043201": [{ type: "text", sub_type: "message", message: "Blue Circles (Safe)", message_ES: "Círculos Azules (Zona-Segura)" }],
		"qb-3043-2000-3043202": [{ type: "text", sub_type: "message", message: "Red Circles (Dodge)", message_ES: "Círculos Rojos (Iframe)" }],
		"qb-3043-2000-3043400": [{ type: "text", sub_type: "message", message: "Break Statues", message_ES: "Romper Escudos" }]
	};
};